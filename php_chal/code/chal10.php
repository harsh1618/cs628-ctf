<?php
  ...
  if(!isset($_SESSION['username'])) {
    ...
    if(array_key_exists("username", $_POST)) {
      $db = new PDO('mysql:host=db;dbname=chal10', 'chal10', 'randomdifficultpassword');
      $db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
      try {
        $date = date("d H:i:s", time() + (330 * 60));
        file_put_contents('/var/www/html/sql10.log', $_SESSION['username'] . " " . $date . " " . $_POST['username'] . "\n", FILE_APPEND);
...
<nav>
  <div class="nav-wrapper">
    <a href="#" class="brand-logo">Challenge 10</a>
  ...
  <div class="col s12 m12">
    <div class="card-panel" style="margin-top:5em; height: 20em; ">
        <div class="row">
          ...
          <form class="col s8", action='/chal10.php', method='POST'>
            <div class="row">
      ...
      <div class = "row">
        <div class="col s2" style="float:right">
          <a href="source10.html" class="waves-effect waves-light btn-large">View Source</a>
        </div>
      </div>
    </div>
  </div>
